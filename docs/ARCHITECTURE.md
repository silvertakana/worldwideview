...
- **Production**: The engine container on Coolify downloads release bundles from `wwv-seeders-community` and the private seeders repository on startup, unzipping them into `/app/seeders`.
